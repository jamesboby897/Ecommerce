...
namespace Ecommerce_Group_Project.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private User CreateUser()
        {
            ...
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(User)}'. Ensure that '{nameof(User)}' has a parameterless constructor.");
            }
        }
